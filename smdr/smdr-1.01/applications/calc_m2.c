/* 
   ...
   default, the full 3-loop results of arXiv:1709.02397 plus the
   leading order in QCD at 4-loop order from 1508.00912. It takes one
   ...
   the full set of MSbar quantities including the value of m2.

   Dimensionful quantities are in appropriate powers of GeV. 
   Timing information for the computation is also printed.
...
int main (int argc, char *argv[])
{
  ...
  SMDR_m2 = SMDR_Eval_m2 (-1, loopOrder);
